...
public class MultipleStatusView extends RelativeLayout {
    ...
    public final void showEmpty() {
        System.out.println("shiming mEmptyViewResId==="+mEmptyViewResId);
    ...
    private View inflateView(int layoutId) {
        System.out.println("shiming mInflater-==="+mInflater);
        System.out.println("shiming layoutId-==="+layoutId);
        if (mInflater==null){
            mInflater = LayoutInflater.from(getContext());
